...
import com.todoandtakeaway.TodoAndTakeaway.rest.webservices.restfulwebservices.user.UserRepository;
...
public class JwtSecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        UserDetails user1 = User.withUsername("becca")
                                .password("{noop}peipei")
                                .authorities("read")
                                .roles("USER")
                                .build();
